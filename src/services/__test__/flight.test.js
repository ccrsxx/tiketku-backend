...
describe('FlightService', () => {
    ...
    describe('getFlights', () => {
        ...
        it('should filter flights by departureDate', async () => {
            const mockFlights = [{ id: '1', departureTimestamp: new Date('2023-12-25') }];
            ...
            expect(prisma.flight.findMany).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it('should sort by cheapestPrice', async () => {
          ...
          it('should sort by shortestDuration', async () => {
            ...
            expect(result.flights[0].durationMinutes).toBeLessThan(result.flights[1].durationMinutes);
          });
          ...
          it('should sort by earliestDeparture', async () => {
            ...
            expect(result.flights[0].departureTimestamp.getTime()).toBeLessThan(result.flights[1].departureTimestamp.getTime()); // Waktu keberangkatan harus terurut dari yang paling awal
          });
          ...
          it('should sort by latestDeparture', async () => {
            ...
            expect(result.flights[0].departureTimestamp.getTime()).toBeGreaterThan(result.flights[1].departureTimestamp.getTime());
            });
          ...
          it('should sort by earliestReturn', async () => {
            ...
            expect(result.flights[0].arrivalTimestamp.getTime()).toBeLessThan(result.flights[1].arrivalTimestamp.getTime()); 
            });
          ...
          it('should sort by latestReturn', async () => {
            ...
            expect(result.flights[0].arrivalTimestamp.getTime()).toBeGreaterThan(result.flights[1].arrivalTimestamp.getTime()); 
          });
});
    ...
    describe('getFavoriteFlights', () => {
        ...
        it('should fetch favorite flights using cursor and return correct meta', async () => {
            ...
            const result = await FlightService.getFavoriteFlights({ nextCursorId: '1', nextCursorPrice: 150 });
        ...
        it('should apply MAX_CURSOR_LIMIT correctly', async () => {
            ...
            const result = await FlightService.getFavoriteFlights({ continent: Continent.ASIA });
